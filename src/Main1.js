      ...
      <main className="Main">
        ...
        <section className="Main-table">
          ...
          <section className="Main-table-body">
            {filtArray.map((game) => (
              <div className="Main-table-row" key={game.id}>
                <div>
                ...
                <div>
                  ...
                  >
                    <img
                      src={game.rating == "Love It" ? heart_s : heart_u}
                      height="25rem"
                    />
                  </button>
                  <button
                  ...
                  >
                    <img
                      src={game.rating == "Like It" ? like_s : like_u}
                      height="25rem"
                    />
                  </button>
                  <button
                  ...
                  >
                    <img
                      src={game.rating == "Meh" ? meh_s : meh_u}
                      height="25rem"
                    />
                  </button>
                  <br />
